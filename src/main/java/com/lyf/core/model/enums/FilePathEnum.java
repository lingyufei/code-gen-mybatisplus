...
public enum FilePathEnum {
    ...
    ENTITY("Entity.java", "/java/${packageName}/controller/"),
    REQUEST("Request.java", "/java/${packageName}/controller/"),
    RESPONSE("Response.java", "/java/${packageName}/controller/"),
    VO("Vo.java", "/java/${packageName}/controller/"),
